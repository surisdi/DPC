...
--num_seq 6 \
--lr 1e-3 \
--prefix future_sub_action_linear_finegym_kinetics_euclidean \
--fp16 \
--pretrain logs/log_train_dpc_eucl_poincare_kinetics/20201019_193949/model/model_best_epoch77.pth.tar \
