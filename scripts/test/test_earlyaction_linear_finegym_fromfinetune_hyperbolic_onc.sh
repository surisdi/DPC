...
CUDA_VISIBLE_DEVICES=4,5,6,7 PYTORCH_JIT=0 NCCL_LL_THRESHOLD=0 python \
  ...
  --fp16 \
  --fp64_hyper \
  --pretrain >> /proj/vondrick/shared/hypvideo/logs/log_earlyaction_linear_finegym_fromfinetune_hyperbolic_onc/20210125_120557/model/model_best_epoch1.pth.tar \
