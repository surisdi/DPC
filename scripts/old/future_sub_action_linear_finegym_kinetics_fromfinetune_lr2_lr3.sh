...
--distance 'squared' \
--lr 1e-2 \
--prefix future_sub_action_linear_finegym_kinetics_lr2_lr3_fromfinetune \
--fp16 \
--fp64_hyper \
...
--only_train_linear \
--reset_lr \
--resume logs/log_future_sub_action_linear_finegym_kinetics_lr2_fromfinetune/20201028_100239/model/model_best_epoch14.pth.tar
