...
CUDA_VISIBLE_DEVICES=0,1,2,3 PYTORCH_JIT=0 NCCL_LL_THRESHOLD=0 python \
  ...
  --distance 'squared' \
  --lr 1e-4 \
  --prefix future_subaction_linear_finegym_fromfinetune_hyperbolic_fromnoneg \
  --fp16 \
  --fp64_hyper \
  --pretrain /proj/vondrick/shared/hypvideo/logs/log_future_subaction_linear_finegym_fromfinetune_hyperbolic_fromnoneg/20210125_113414/model/model_best_epoch64.pth.tar \
