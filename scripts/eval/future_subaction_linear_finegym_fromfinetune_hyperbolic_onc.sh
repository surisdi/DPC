...
CUDA_VISIBLE_DEVICES=4,5,6,7 PYTORCH_JIT=0 NCCL_LL_THRESHOLD=0 python \
  ...
  --distance 'squared' \
  --lr 1e-2 \
  --prefix future_subaction_linear_finegym_fromfinetune_hyperbolic_onzhat_lr2 \
  --fp16 \
  --fp64_hyper \
  --pretrain /proj/vondrick/shared/hypvideo/logs/log_finetune_dpc_self_hyper_v1_poincare_finegym_fromearlyaction/20201028_122531/model/model_best_epoch7.pth.tar \
