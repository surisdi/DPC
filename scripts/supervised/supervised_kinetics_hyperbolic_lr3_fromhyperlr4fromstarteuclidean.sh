...
CUDA_VISIBLE_DEVICES=4,5,6,7 PYTORCH_JIT=0 NCCL_LL_THRESHOLD=0 python \
  ...
  --num_seq 8 \
  --lr 1e-3 \
  --prefix supervised_kinetics_hyperbolic_lr3_fromlr4fromstarteuclidean \
  --action_level_gt \
  --fp16 \
  ...
  --distance 'squared' \
  --fp64_hyper \
  --pretrain /proj/vondrick/shared/hypvideo/logs/log_supervised_kinetics_hyperbolic_lr4_fromstarteuclidean/20210120_173946/model/model_best_epoch6_.pth.tar
