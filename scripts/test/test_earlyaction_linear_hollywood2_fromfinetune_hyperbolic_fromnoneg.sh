...
CUDA_VISIBLE_DEVICES=5,6,7 PYTORCH_JIT=0 NCCL_LL_THRESHOLD=0 python \
  ...
  --distance 'squared' \
  --lr 1e-2 \
  --prefix earlyaction_linear_hollywood2_fromfinetune_hyperbolic_fromnoneg \
  --fp16 \
  --fp64_hyper \
  --pretrain /proj/vondrick/shared/hypvideo/logs/log_earlyaction_linear_hollywood2_fromfinetune_hyperbolic_fromnoneg/20210125_113509/model/model_best_epoch71.pth.tar \
